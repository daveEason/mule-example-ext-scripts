...
-----------------------------------------------------------------
./src/test/java/com.mulesoft.example/muleexampleextscripts/MuleexampleextscriptsTestCase.java
...
artifactId=muleexampleextscripts
description=Example Mule application to demonstrate WebService calling external shell scripts
muleVersion=3.2.0
